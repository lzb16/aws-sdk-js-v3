...
dependencies {
    api("software.amazon.smithy:smithy-aws-traits:1.6.1")
    api("software.amazon.smithy:smithy-waiters:1.6.1")
    api("software.amazon.smithy:smithy-aws-iam-traits:1.6.1")
