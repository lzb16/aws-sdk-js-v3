...
import { GetOSCPConfigurationOutput, GetOSCPConfigurationRequest } from "../models/models_0";
import {
  deserializeAws_restXmlGetOSCPConfigurationCommand,
  serializeAws_restXmlGetOSCPConfigurationCommand,
...
export type GetOSCPConfigurationCommandInput = GetOSCPConfigurationRequest;
export type GetOSCPConfigurationCommandOutput = GetOSCPConfigurationOutput & __MetadataBearer;
 ...
 *          </ul>
 */
export class GetOSCPConfigurationCommand extends $Command<
...
> {
  ...
  constructor(readonly input: GetOSCPConfigurationCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<GetOSCPConfigurationCommandInput, GetOSCPConfigurationCommandOutput> {
    ...
    const commandName = "GetOSCPConfigurationCommand";
    const handlerExecutionContext: HandlerExecutionContext = {
      logger,
      clientName,
      commandName,
      inputFilterSensitiveLog: GetOSCPConfigurationRequest.filterSensitiveLog,
      outputFilterSensitiveLog: GetOSCPConfigurationOutput.filterSensitiveLog,
    };
  ...
  private serialize(input: GetOSCPConfigurationCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restXmlGetOSCPConfigurationCommand(input, context);
  }

  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetOSCPConfigurationCommandOutput> {
    return deserializeAws_restXmlGetOSCPConfigurationCommand(output, context);
  }
