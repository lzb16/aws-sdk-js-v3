...
import { GetRefererOutput, GetRefererRequest } from "../models/models_1";
import {
  deserializeAws_restXmlGetRefererCommand,
  serializeAws_restXmlGetRefererCommand,
...
export type GetRefererCommandInput = GetRefererRequest;
export type GetRefererCommandOutput = GetRefererOutput & __MetadataBearer;
 ...
 *          </ul>
 */
export class GetRefererCommand extends $Command<
...
> {
  ...
  constructor(readonly input: GetRefererCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<GetRefererCommandInput, GetRefererCommandOutput> {
    ...
    const commandName = "GetRefererCommand";
    const handlerExecutionContext: HandlerExecutionContext = {
      logger,
      clientName,
      commandName,
      inputFilterSensitiveLog: GetRefererRequest.filterSensitiveLog,
      outputFilterSensitiveLog: GetRefererOutput.filterSensitiveLog,
    };
  ...
  private serialize(input: GetRefererCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restXmlGetRefererCommand(input, context);
  }

  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetRefererCommandOutput> {
    return deserializeAws_restXmlGetRefererCommand(output, context);
  }
