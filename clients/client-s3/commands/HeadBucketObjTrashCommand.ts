...
import { HeadBucketObjTrashRequest, HeadObjectOutput } from "../models/models_1";
import {
  deserializeAws_restXmlHeadBucketObjTrashCommand,
  serializeAws_restXmlHeadBucketObjTrashCommand,
...
export type HeadBucketObjTrashCommandInput = HeadBucketObjTrashRequest;
export type HeadBucketObjTrashCommandOutput = HeadObjectOutput & __MetadataBearer;
 ...
 *          </ul>
 */
export class HeadBucketObjTrashCommand extends $Command<
...
> {
  ...
  constructor(readonly input: HeadBucketObjTrashCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<HeadBucketObjTrashCommandInput, HeadBucketObjTrashCommandOutput> {
    ...
    const commandName = "HeadBucketObjTrashCommand";
    const handlerExecutionContext: HandlerExecutionContext = {
      logger,
      clientName,
      commandName,
      inputFilterSensitiveLog: HeadBucketObjTrashRequest.filterSensitiveLog,
  ...
  private serialize(input: HeadBucketObjTrashCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restXmlHeadBucketObjTrashCommand(input, context);
  }

  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<HeadBucketObjTrashCommandOutput> {
    return deserializeAws_restXmlHeadBucketObjTrashCommand(output, context);
  }
