...
import { PutRefererRequest } from "../models/models_1";
import {
  deserializeAws_restXmlPutRefererCommand,
  serializeAws_restXmlPutRefererCommand,
...
export type PutRefererCommandInput = PutRefererRequest;
export type PutRefererCommandOutput = __MetadataBearer;
 ...
 *          </ul>
 */
export class PutRefererCommand extends $Command<
...
> {
  ...
  constructor(readonly input: PutRefererCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<PutRefererCommandInput, PutRefererCommandOutput> {
    ...
    const commandName = "PutRefererCommand";
    const handlerExecutionContext: HandlerExecutionContext = {
      logger,
      clientName,
      commandName,
      inputFilterSensitiveLog: PutRefererRequest.filterSensitiveLog,
  ...
  private serialize(input: PutRefererCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_restXmlPutRefererCommand(input, context);
  }

  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<PutRefererCommandOutput> {
    return deserializeAws_restXmlPutRefererCommand(output, context);
  }
