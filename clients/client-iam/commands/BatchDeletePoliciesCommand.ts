 ...
 */
export class BatchDeletePoliciesCommand extends $Command<
...
> {
  ...
  constructor(readonly input: BatchDeletePoliciesCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<BatchDeletePoliciesCommandInput, BatchDeletePoliciesCommandOutput> {
    ...
    const commandName = "BatchDeletePoliciesCommand";
  ...
  private serialize(input: BatchDeletePoliciesCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_queryBatchDeletePoliciesCommand(input, context);
  }

  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<BatchDeletePoliciesCommandOutput> {
    return deserializeAws_queryBatchDeletePoliciesCommand(output, context);
  }
