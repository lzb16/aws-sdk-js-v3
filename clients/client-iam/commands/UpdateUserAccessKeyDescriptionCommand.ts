...
import { UpdateUserAccessKeyDescriptionRequest } from "../models/models_1";
import {
  deserializeAws_queryUpdateUserAccessKeyDescriptionCommand,
  serializeAws_queryUpdateUserAccessKeyDescriptionCommand,
...
export type UpdateUserAccessKeyDescriptionCommandInput = UpdateUserAccessKeyDescriptionRequest;
export type UpdateUserAccessKeyDescriptionCommandOutput = __MetadataBearer;
 ...
 *          </note>
 */
export class UpdateUserAccessKeyDescriptionCommand extends $Command<
...
> {
  ...
  constructor(readonly input: UpdateUserAccessKeyDescriptionCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<UpdateUserAccessKeyDescriptionCommandInput, UpdateUserAccessKeyDescriptionCommandOutput> {
    ...
    const commandName = "UpdateUserAccessKeyDescriptionCommand";
    const handlerExecutionContext: HandlerExecutionContext = {
      logger,
      clientName,
      commandName,
      inputFilterSensitiveLog: UpdateUserAccessKeyDescriptionRequest.filterSensitiveLog,
  ...
  private serialize(
    ...
    return serializeAws_queryUpdateUserAccessKeyDescriptionCommand(input, context);
  }
  ...
  private deserialize(
    ...
    return deserializeAws_queryUpdateUserAccessKeyDescriptionCommand(output, context);
  }
