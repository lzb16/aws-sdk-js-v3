...
import { deserializeAws_queryGetAccountCommand, serializeAws_queryGetAccountCommand } from "../protocols/Aws_query";
...
> {
  ...
  private serialize(input: GetAccountCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_queryGetAccountCommand(input, context);
  }

  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<GetAccountCommandOutput> {
    return deserializeAws_queryGetAccountCommand(output, context);
  }
