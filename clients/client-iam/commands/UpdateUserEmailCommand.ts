...
import { UpdateUserEmailRequest } from "../models/models_1";
import {
  deserializeAws_queryUpdateUserEmailCommand,
  serializeAws_queryUpdateUserEmailCommand,
...
export type UpdateUserEmailCommandInput = UpdateUserEmailRequest;
export type UpdateUserEmailCommandOutput = __MetadataBearer;
 ...
 *          </note>
 */
export class UpdateUserEmailCommand extends $Command<
...
> {
  ...
  constructor(readonly input: UpdateUserEmailCommandInput) {
  ...
  resolveMiddleware(
  ...
  ): Handler<UpdateUserEmailCommandInput, UpdateUserEmailCommandOutput> {
    ...
    const commandName = "UpdateUserEmailCommand";
    const handlerExecutionContext: HandlerExecutionContext = {
      logger,
      clientName,
      commandName,
      inputFilterSensitiveLog: UpdateUserEmailRequest.filterSensitiveLog,
  ...
  private serialize(input: UpdateUserEmailCommandInput, context: __SerdeContext): Promise<__HttpRequest> {
    return serializeAws_queryUpdateUserEmailCommand(input, context);
  }

  private deserialize(output: __HttpResponse, context: __SerdeContext): Promise<UpdateUserEmailCommandOutput> {
    return deserializeAws_queryUpdateUserEmailCommand(output, context);
  }
