...
export interface ChangeAccountAccessTypeRequest {
  /**
   * <p>Account name.</p>
   */
  AccountName?: string;
...
export namespace ChangeAccountAccessTypeRequest {
  export const filterSensitiveLog = (obj: ChangeAccountAccessTypeRequest): any => ({
    ...obj,
